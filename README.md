...
2. Add the path to the `quick-ssh/bin` folder to your `PATH` environment variable.

When you run `composer global require danielwinning/quick-ssh`, your terminal will `cd` into your composer installations
